...
[![Release: v1.0.1](https://img.shields.io/badge/Release-v1.0.1-brightgreen.svg)](https://github.com/disface/sentinel-community-manager/releases/tag/v1.0.1)
...
1. Скачайте готовый файл **`Sentinel-Community-Manager-Portable.exe`** со страницы [Releases](https://github.com/disface/sentinel-community-manager/releases/latest) (текущая стабильная версия: **v1.0.1**; подробности см. в [CHANGELOG.md](CHANGELOG.md)).
